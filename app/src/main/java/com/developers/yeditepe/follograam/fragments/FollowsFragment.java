...
public class FollowsFragment extends FollograamBaseFragment implements UserStatusUpdateListener, View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        followsCountTextView.setText("There are " + getFollowsUserList().size() + " users that you follow");
        listAdapter = new FollowsUserListAdapter(getContext(), this, getFollowsUserList());
        followUsersListView.setAdapter(listAdapter);
        refreshButton.setOnClickListener(this);
        cancelButton.setOnClickListener(this);
        actionBar.setTitle("Follows");
    }
