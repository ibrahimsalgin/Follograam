...
public class FollowedByFragment extends FollograamBaseFragment implements UserStatusUpdateListener, View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        followsCountTextView.setText("You are being followed by "+getFollowedByUserList().size()+" users");
        listAdapter = new FollowsUserListAdapter(getContext(), this,  getFollowedByUserList());
    ...
    public void onClick(View view) {
        ...
        if (toBeRefreshedUserList.isEmpty()){
